...
import { CloudSun, Wind, Droplets, Thermometer, MapPin, Info, ZoomIn, ZoomOut, RotateCcw } from 'lucide-react';
...
const ZONES: ZoneData[] = [
  { id: '1', name: 'Delhi North', aqi: 342, temp: 32, rainfall: '0mm', status: 'danger', coordinates: { x: 45, y: 35 } },
  { id: '2', name: 'Delhi South', aqi: 210, temp: 31, rainfall: '2mm', status: 'warning', coordinates: { x: 55, y: 65 } },
  { id: '3', name: 'Gurugram', aqi: 380, temp: 33, rainfall: '0mm', status: 'danger', coordinates: { x: 30, y: 75 } },
  { id: '4', name: 'Noida', aqi: 180, temp: 30, rainfall: '5mm', status: 'safe', coordinates: { x: 75, y: 60 } },
  { id: '5', name: 'Faridabad', aqi: 290, temp: 32, rainfall: '0mm', status: 'warning', coordinates: { x: 65, y: 85 } },
  { id: '6', name: 'Delhi West', aqi: 310, temp: 31, rainfall: '0mm', status: 'danger', coordinates: { x: 35, y: 50 } },
];

export function WeatherMap() {
  const [selectedZone, setSelectedZone] = useState<ZoneData | null>(ZONES[0]);
    ...
    <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
      ...
      <div className="lg:col-span-1 space-y-4">
        <div className="p-4 bg-card/30 rounded-2xl border border-white/5">
          <p className="text-[10px] font-bold text-text-secondary uppercase tracking-widest mb-4">Select Zone</p>
          <AnimatedList 
            items={zoneNames} 
